...
export default function AuthPage() {
    const loginImage = "src/assets/Twitter-BGK.png"
    const url = "https://06d24b26-e181-46a0-b9e8-3920dc8d72ff-00-38nde5nv43byx.pike.replit.dev:3000";

    const [modalShow, setModalShow] = useState(null);
    const handleShowSignUp = () => setModalShow("Sign Up");
                    ...
                    <Modal.Body>
                        ...
                        <Form className="d-grid gap-2 px-5" onSubmit={modalShow === "SignUp" ? handleSignUp : handleLogin}>
                            ...
                            <p style={{ fontSize: "12px" }}>
                                ...
                                informaion, including your email address and phone number for purposes outlined in our Privacy Policy, like keeping your account secure
                                and personalizing our services, including ads. Learn more. Others will be able to find you by email or phone number, when provided,
